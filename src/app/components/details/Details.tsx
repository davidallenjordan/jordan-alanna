  ...
  return (
    ...
    >
      <div className="container py-[60px]">
        <h2 className="heading-2 text-accent pb-[16px] sm:pb-[32px] text-center">Details</h2>

        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-[40px] font-didot">
          {/* Location */}
          <li>
            <h3 className="heading-3 text-accent mb-3">Location</h3>
            <p className="text-accent mb-4 font-didot">
            ...
            <h4 className="font-didot text-accent text-lg font-bold mb-1">Parking</h4>
            ...
            <h4 className="heading-4 text-accent mb-1">Public Transit</h4>
            <p className="text-accent mb-4">
          ...
          {/* Accommodations */}
          <li>
            <h3 className="heading-3 text-accent mb-3">Accommodations</h3>
            <p className="text-accent mb-4">
            ...
            <div className="mb-4">
              <h4 className="font-didot text-accent text-lg font-bold mb-1">The Drake Hotel</h4>
            ...
            <div>
              <h4 className="font-didot text-accent text-lg font-bold mb-1">The Gladstone House</h4>
              <p className="text-accent mb-2">
          ...
          {/* Gifts */}
          <li>
            <h3 className="heading-3 text-accent mb-3">Gifts</h3>
          ...
          {/* Dress Code */}
          <li>
            <h3 className="heading-3 text-accent mb-3">Dress Code</h3>
            <p className="text-accent">
